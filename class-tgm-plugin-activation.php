 ...
 *
 * Main library that takes the array of plugins and installs
 * and activates them. 
 *
 * @package   TGM-Plugin-Activation
 * @version   2.6.1
 * @link      http://tgmpluginactivation.com/
 * @copyright Code snippets used from Thomas Griffin
 * @license   GPL-2.0+
 */
		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_recommended'  => _n_noop(
					/* translators: 1: plugin name(s). */
					'This theme could require the following plugin: %1$s.',
					'This theme could require the following plugins: %1$s.',
					'tgmpa'
				),
